...
This project is indexed by GitNexus as **Settlers.ts** (7260 symbols, 24548 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
