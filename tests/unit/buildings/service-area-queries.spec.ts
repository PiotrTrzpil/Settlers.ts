...
describe('ServiceAreaManager', () => {
    ...
    describe('createServiceArea', () => {
        ...
        it('should create a service area with custom radius', () => {
            const area = manager.createServiceArea(1, 0, 50, 50, TEST_HUB_TYPE, 20);
    ...
    describe('removeServiceArea', () => {
        it('should remove an existing service area', () => {
            manager.createServiceArea(1, 0, 50, 50, TEST_HUB_TYPE);
...
describe('getBuildingsInServiceArea', () => {
    ...
    it('should return empty array when no buildings in service area', () => {
        const area = manager.createServiceArea(1, 0, 50, 50, TEST_HUB_TYPE, 5);
...
describe('isPositionInAnyServiceArea', () => {
    ...
    it('should return true when position is in at least one service area', () => {
        manager.createServiceArea(1, 0, 50, 50, TEST_HUB_TYPE, 10);
        manager.createServiceArea(2, 0, 100, 100, TEST_HUB_TYPE, 10);
...
describe('getHubsServingBothPositions', () => {
    ...
    it('should return hubs covering both source and destination', () => {
        ...
        manager.createServiceArea(2, 0, 55, 55, TEST_HUB_TYPE, 5); // Only covers source area
    ...
    it('should return empty array when no hub covers both positions', () => {
        manager.createServiceArea(1, 0, 50, 50, TEST_HUB_TYPE, 5);
        manager.createServiceArea(2, 0, 100, 100, TEST_HUB_TYPE, 5);
    ...
    it('should handle overlapping service areas', () => {
        manager.createServiceArea(1, 0, 50, 50, TEST_HUB_TYPE, 15);
        manager.createServiceArea(2, 0, 55, 55, TEST_HUB_TYPE, 15);
...
describe('Edge cases', () => {
    ...
    it('should handle odd Y row positions correctly (hex grid)', () => {
        const area = createServiceArea(1, 0, 50, 51, TEST_HUB_TYPE, 10);
    ...
    it('should handle large radius values up to MAX', () => {
        const area = manager.createServiceArea(1, 0, 50, 50, TEST_HUB_TYPE, MAX_SERVICE_RADIUS);
    ...
    it('should handle negative coordinates', () => {
        const area = createServiceArea(1, 0, -10, -10, TEST_HUB_TYPE, 10);
