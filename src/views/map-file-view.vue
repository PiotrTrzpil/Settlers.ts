            ...
            <main class="main-content">
                ...
                <section v-if="entitySummary" class="card entity-data-card">
                    ...
                    <div v-if="entitySummary.players.length > 0" class="entity-section">
                        <h3>
                            Players <span class="entity-count">({{ entitySummary.totals.players }})</span>
                        </h3>
                        <div class="entity-list players-list">
                            <div v-for="p in entitySummary.players" :key="p.index" class="entity-row player-row">
                                ...
                                <span v-if="p.startX && p.startY" class="player-pos"
                                    >({{ p.startX }}, {{ p.startY }})</span
                                >
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="entitySummary.buildings.length > 0" class="entity-section">
                        <h3>
                            Buildings <span class="entity-count">({{ entitySummary.totals.buildings }})</span>
                        </h3>
                        <div class="entity-list">
                            <div
                                v-for="(b, idx) in entitySummary.buildings.slice(0, 10)"
                                :key="'bld-' + idx"
                                class="entity-row"
                            >
                    ...
                    <div v-if="entitySummary.settlers.length > 0" class="entity-section">
                        <h3>
                            Settlers <span class="entity-count">({{ entitySummary.totals.settlers }})</span>
                        </h3>
                        <div class="entity-list">
                            <div
                                v-for="(s, idx) in entitySummary.settlers.slice(0, 10)"
                                :key="'stl-' + idx"
                                class="entity-row"
                            >
                    ...
                    <div v-if="entitySummary.stacks.length > 0" class="entity-section">
                        <h3>
                            Material Stacks <span class="entity-count">({{ entitySummary.totals.stacks }})</span>
                        </h3>
                        <div class="entity-list">
                            <div
                                v-for="(st, idx) in entitySummary.stacks.slice(0, 10)"
                                :key="'stk-' + idx"
                                class="entity-row"
                            >
                    ...
                    <div
                        v-if="
                            entitySummary.totals.players === 0 &&
                ...
                <section v-if="stats && stats.terrain.length > 0" class="card stats-card">
                    <h2>
                        Terrain Types <span class="stat-total">({{ stats.totalTerrain.toLocaleString() }} tiles)</span>
                    </h2>
                ...
                <section v-if="stats && stats.resources.length > 0" class="card stats-card">
                    <h2>
                        Resource Details <span class="stat-total">({{ stats.totalResources.toLocaleString() }})</span>
                    </h2>
                    <div class="stat-bars">
                        <div v-for="entry in stats.resources.slice(0, 15)" :key="'res-' + entry.value" class="stat-bar">
                            <span class="stat-label" :title="'Value: ' + entry.value">{{ entry.name }}</span>
                            <div class="bar-container">
                                <div
...
.resource-item.stonemine {
    border-left: 3px solid #6a6a70;
}
.resource-item.stone {
    border-left: 3px solid #a0a0a0;
}
.resource-item.wood {
    border-left: 3px solid #4a8040;
}
