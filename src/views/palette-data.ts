...
export const ALL_UNITS: { type: UnitType; id: string; name: string; icon: string }[] = [
    ...
    { type: UnitType.SunflowerFarmer, id: 'sunflowerfarmer', name: 'Sunflower Farmer', icon: '🌻' },
    { type: UnitType.SunflowerOilMaker, id: 'sunfloweroilmaker', name: 'Sunflower Oil Maker', icon: '🫒' },
    { type: UnitType.Beekeeper, id: 'beekeeper', name: 'Beekeeper', icon: '🐝' },
    { type: UnitType.Baker, id: 'baker', name: 'Baker', icon: '🍞' },
    { type: UnitType.AnimalFarmer, id: 'animalfarmer', name: 'Animal Farmer', icon: '🐄' },
    { type: UnitType.Waterworker, id: 'waterworker', name: 'Water Worker', icon: '💧' },
