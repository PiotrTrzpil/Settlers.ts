...
function mapS4ToInternalType(s4Type: number): number {
    const mapping: Record<number, BuildingType> = {
        [S4_BUILDING_TYPES.WOODCUTTERHUT]: BuildingType.Lumberjack,
        [S4_BUILDING_TYPES.FORESTERHUT]: BuildingType.Forester,
        [S4_BUILDING_TYPES.SAWMILL]: BuildingType.Sawmill,
        [S4_BUILDING_TYPES.STONECUTTERHUT]: BuildingType.Stonecutter,
        [S4_BUILDING_TYPES.WATERWORKHUT]: BuildingType.Waterworks,
        [S4_BUILDING_TYPES.FISHERHUT]: BuildingType.Fishery,
        [S4_BUILDING_TYPES.HUNTERHUT]: BuildingType.Hunter,
        [S4_BUILDING_TYPES.SLAUGHTERHOUSE]: BuildingType.Slaughterhouse,
        [S4_BUILDING_TYPES.MILL]: BuildingType.Windmill,
        [S4_BUILDING_TYPES.BAKERY]: BuildingType.Bakery,
        [S4_BUILDING_TYPES.GRAINFARM]: BuildingType.Farm,
        [S4_BUILDING_TYPES.ANIMALRANCH]: BuildingType.PigFarm,
        [S4_BUILDING_TYPES.DONKEYRANCH]: BuildingType.DonkeyFarm,
        ...
        [S4_BUILDING_TYPES.SMELTGOLD]: BuildingType.GoldSmelter,
        ...
        [S4_BUILDING_TYPES.HEALERHUT]: BuildingType.Healer,
        [S4_BUILDING_TYPES.AMMOMAKERHUT]: BuildingType.AmmunitionMaker,
        [S4_BUILDING_TYPES.SHIPYARD]: BuildingType.Shipyard,
        [S4_BUILDING_TYPES.STORAGEAREA]: BuildingType.Warehouse,
        [S4_BUILDING_TYPES.RESIDENCESMALL]: BuildingType.SmallHouse,
        [S4_BUILDING_TYPES.RESIDENCEMEDIUM]: BuildingType.MediumHouse,
        [S4_BUILDING_TYPES.RESIDENCEBIG]: BuildingType.LargeHouse,
        [S4_BUILDING_TYPES.SMALLTEMPLE]: BuildingType.SmallTemple,
        [S4_BUILDING_TYPES.BIGTEMPLE]: BuildingType.LargeTemple,
        [S4_BUILDING_TYPES.LOOKOUTTOWER]: BuildingType.ScoutTower,
        [S4_BUILDING_TYPES.GUARDTOWERSMALL]: BuildingType.Tower,
        [S4_BUILDING_TYPES.GUARDTOWERBIG]: BuildingType.LargeTower,
