...
export const BUILDING_OVERLAY_JIL_INDICES: Readonly<Record<string, OverlayJilEntry | null>> = {
    ...
    BUILDING_CASTLE_TOWER1: { dir: 3 },
    BUILDING_CASTLE_TOWER1_FRONTWALL: { dir: 2 },
    BUILDING_CASTLE_TOWER2: { dir: 4 },
    BUILDING_CASTLE_TOWER2_FRONTWALL: { dir: 5 },
    BUILDING_CASTLE_TOWER3: { dir: 6 },
    BUILDING_CASTLE_TOWER3_FRONTWALL: { dir: 7 },
    ...
    BUILDING_GUARDTOWERBIG_DOOR: { dir: 3 },
    BUILDING_GUARDTOWERBIG_FRONTWALL: { dir: 2 },
    BUILDING_GUARDTOWERSMALL_DOOR: { dir: 3 },
    BUILDING_GUARDTOWERSMALL_FRONTWALL: { dir: 2 },
