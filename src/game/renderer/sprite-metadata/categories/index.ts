/**
 * Sprite category modules.
 * Each category manages a specific domain of sprites.
 *
...
export { DecorationSpriteCategory } from './decoration-sprite-category';
export { OverlaySpriteCategory } from './overlay-sprite-category';
export { AnimatedEntityCategory } from './animated-entity-category';
