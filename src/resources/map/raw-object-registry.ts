...
export const RAW_OBJECT_REGISTRY: readonly RawObjectEntry[] = [
    ...
    { raw: 23, label: 'Bush5', category: MapObjectCategory.Plants, notes: 'Uncommon (2.6k); guessed Bush5', type: MapObjectType.Bush5 },
    { raw: 24, label: 'Bush6', category: MapObjectCategory.Plants, notes: 'Uncommon (2k); guessed Bush6', type: MapObjectType.Bush6 },
    { raw: 25, label: 'Bush7', category: MapObjectCategory.Plants, notes: 'Uncommon (1.8k); guessed Bush7', type: MapObjectType.Bush7 },
    { raw: 26, label: 'Bush8', category: MapObjectCategory.Plants, notes: 'Uncommon (1.6k); guessed Bush8', type: MapObjectType.Bush8 },
    { raw: 27, label: 'Bush9', category: MapObjectCategory.Plants, notes: 'Uncommon (1.8k); guessed Bush9', type: MapObjectType.Bush9 },
    { raw: 28, label: 'Flower1', category: MapObjectCategory.Plants, notes: 'Uncommon (1.8k); guessed Flower1', type: MapObjectType.Flower1 },
    { raw: 29, label: 'Flower2', category: MapObjectCategory.Plants, notes: 'Uncommon (3k); guessed Flower2', type: MapObjectType.Flower2 },
    // raw 30: not observed on any map
    { raw: 31, label: 'Foliage1', category: MapObjectCategory.Plants, notes: 'Uncommon (857); guessed Foliage1', type: MapObjectType.Foliage1 },
    ...
    { raw: 93, label: 'DarkPlant93', category: MapObjectCategory.DarkGround, notes: 'dark-land:93%, 532 across 44 maps; was Plants' },
    // raw 94-98: not observed on any map
    { raw: 99, label: 'DarkPlant99', category: MapObjectCategory.DarkGround, notes: 'dark-land:95%, 465 across 40 maps; was Plants' },
    { raw: 100, label: 'DarkPlant100', category: MapObjectCategory.DarkGround, notes: 'dark-land:95%, 402 across 44 maps; was Plants' },
    ...
    { raw: 111, label: 'DarkPlant111', category: MapObjectCategory.DarkGround, notes: 'dark-land:95%, 1879 across 49 maps; was Plants' },
    { raw: 112, label: 'DarkPlant112', category: MapObjectCategory.DarkGround, notes: 'dark-land:95%, 1100 across 47 maps; was Plants' },
    ...
    { raw: 124, label: 'HarvestableStone', category: MapObjectCategory.HarvestableStone, notes: 'Level 1 of 12 (nearly depleted)', type: MapObjectType.ResourceStone, variation: 1 },
    { raw: 125, label: 'HarvestableStone', category: MapObjectCategory.HarvestableStone, notes: 'Level 2 of 12', type: MapObjectType.ResourceStone, variation: 2 },
    { raw: 126, label: 'HarvestableStone', category: MapObjectCategory.HarvestableStone, notes: 'Level 3 of 12', type: MapObjectType.ResourceStone, variation: 3 },
    { raw: 127, label: 'HarvestableStone', category: MapObjectCategory.HarvestableStone, notes: 'Level 4 of 12', type: MapObjectType.ResourceStone, variation: 4 },
    { raw: 128, label: 'HarvestableStone', category: MapObjectCategory.HarvestableStone, notes: 'Level 5 of 12', type: MapObjectType.ResourceStone, variation: 5 },
    { raw: 129, label: 'HarvestableStone', category: MapObjectCategory.HarvestableStone, notes: 'Level 6 of 12', type: MapObjectType.ResourceStone, variation: 6 },
    { raw: 130, label: 'HarvestableStone', category: MapObjectCategory.HarvestableStone, notes: 'Level 7 of 12', type: MapObjectType.ResourceStone, variation: 7 },
    { raw: 131, label: 'HarvestableStone', category: MapObjectCategory.HarvestableStone, notes: 'Level 8 of 12', type: MapObjectType.ResourceStone, variation: 8 },
    { raw: 132, label: 'HarvestableStone', category: MapObjectCategory.HarvestableStone, notes: 'Level 9 of 12', type: MapObjectType.ResourceStone, variation: 9 },
    { raw: 133, label: 'HarvestableStone', category: MapObjectCategory.HarvestableStone, notes: 'Level 10 of 12', type: MapObjectType.ResourceStone, variation: 10 },
    { raw: 134, label: 'HarvestableStone', category: MapObjectCategory.HarvestableStone, notes: 'Level 11 of 12', type: MapObjectType.ResourceStone, variation: 11 },
    { raw: 135, label: 'HarvestableStone', category: MapObjectCategory.HarvestableStone, notes: 'Level 12 of 12 (full)', type: MapObjectType.ResourceStone, variation: 12 },
    ...
    { raw: 150, label: 'DarkPlant150', category: MapObjectCategory.DarkGround, notes: 'dark-land:100%, 12 across 7 maps; was Plants' },
    ...
    { raw: 164, label: 'WaterLily1', category: MapObjectCategory.Lake, notes: 'On lakes (242k); guessed WaterLily1', type: MapObjectType.WaterLily1 },
    ...
    { raw: 167, label: 'WaterLily2', category: MapObjectCategory.Lake, notes: 'On lakes (85k); guessed WaterLily2', type: MapObjectType.WaterLily2 },
    { raw: 168, label: 'WaterLily3', category: MapObjectCategory.Lake, notes: 'On lakes (85k); guessed WaterLily3', type: MapObjectType.WaterLily3 },
    ...
    { raw: 0xc4, label: 'Oak (magic)', category: MapObjectCategory.Trees, notes: 'Secondary value (Siedler-Portal)', type: MapObjectType.TreeOak },
    { raw: 0xc5, label: 'Pine (magic)', category: MapObjectCategory.Trees, notes: 'Secondary value (Siedler-Portal)', type: MapObjectType.TreePine },
    { raw: 0xc6, label: 'Coconut (magic)', category: MapObjectCategory.Trees, notes: 'Secondary value (Siedler-Portal); Palm → Coconut/Date', type: MapObjectType.TreeCoconut },
    ...
    { raw: 219, label: 'WaggonDestroyed', category: MapObjectCategory.DesertRare, notes: 'On desert, rare; pool→WAGON_WRECK', type: MapObjectType.WaggonDestroyed },
...
// ============================================================
// Reverse lookup: MapObjectType → raw byte
// ============================================================
